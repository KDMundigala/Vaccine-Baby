// ... copy of your BeforeUI/pages/loginform.jsx but converted to TypeScript
import React, { useState } from 'react';
import { TextField, Typography, Paper, Box, InputAdornment, CircularProgress, Snackbar, Alert, AlertColor } from '@mui/material';
...
const LoginPage = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      // Using POST method for login (not GET)
