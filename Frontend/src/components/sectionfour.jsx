...
import backgroundImg from '/src/assets/section10.png';
import LearnMoreButton from '/src/assets/learnmore.png';
import rightsideImg from '/src/assets/sectionfour.png';
...
function MyComponent() {
  ...
  // Handler for Learn More button navigation
    ...
    >
      ...
      >
        ...
        <Box sx={{ maxWidth: '55%', pl: 5, position: 'relative' }}>
          ...
          >
            Discover latest <span style={{ 
              color: 'rgba(126, 163, 96, 1)',
              position: 'relative',
            }}>features</span>
          </Typography>
          ...
          >
            "Discover the latest features designed to simplify your parenting journey. From scheduling vaccinations and tracking your child’s growth milestones to chatting with a midwife and accessing helpful FAQs, our platform provides all the tools you need to ensure your baby's health and well-being."
          </Typography>
          
          {/* Learn more image button with modern animation */}
          <Box
            component="a"
            href="#"
